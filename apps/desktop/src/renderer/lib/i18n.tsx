...
const en: TranslationMap = {
  ...
  "settings.remote.subtitle": "Clients sign in with the account token and pick this device from their device list",
  "settings.remote.relayUrl": "Relay server (ws:// or wss://)",
  "settings.remote.deviceId": "Device ID (stable across upgrades; shown in the client's device list)",
