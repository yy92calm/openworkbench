...
const en: TranslationMap = {
  ...
  "settings.dataFlow.local2": "Code runs locally - the Python kernel and Jupyter execute here; datasets are never uploaded in bulk.",
  "settings.dataFlow.local3": "Session history and a traceable record of every artifact, in the app's private folder.",
  ...
  "settings.dataFlow.sent2": "Nothing sent in the background - data leaves only during a conversation turn.",
  "settings.dataFlow.sent3": "What the provider keeps is governed by its own privacy policy.",
  "settings.dataFlow.footnote": "Bundled skills and MCP servers may make their own network calls - review the .opencode profile before packaging.",
...
const zhCN: TranslationMap = {
  ...
  "settings.dataFlow.local2": "代码在本地运行——Python 内核与 Jupyter 就地执行，数据集不会批量上传。",
  "settings.dataFlow.local3": "会话历史与每个产物的可追溯记录，保存在应用私有目录。",
  ...
  "settings.dataFlow.sent2": "不会后台发送——数据仅在对话轮次中离开本机。",
  "settings.dataFlow.sent3": "供应商保留什么，由其自身隐私政策决定。",
  "settings.dataFlow.footnote": "内置技能与 MCP 服务器可能自行发起网络请求——打包前请检查 .opencode 配置。",
