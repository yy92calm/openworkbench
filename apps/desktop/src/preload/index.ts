...
const api = {
  ...
  addTextToWorkspace: (filename: string, content: string) =>
    ipcRenderer.invoke('add-text-to-workspace', filename, content),
  ...
  writeWorkspaceFile: (rel: string, content: string, root?: string) =>
    ipcRenderer.invoke('write-workspace-file', rel, content, root),
  ...
  storeSet: (key: string, value: unknown, scope?: string) =>
    ipcRenderer.invoke('store-set', key, value, scope),
  ...
  browserRecordSave: (name: string, description?: string) =>
    ipcRenderer.invoke('browser:record-save', name, description),
  browserRecordList: () => ipcRenderer.invoke('browser:record-list'),
  browserRecordReplay: (name: string, delay?: number) =>
    ipcRenderer.invoke('browser:record-replay', name, delay),
